...
<div class="container">
  ...
  <table class="table">
    ...
    <tbody>
    <c:forEach items="${listSanPham}" var="listsanpham" varStatus="loop">
      <tr>
        <td>${listsanpham.tenSP}</td>
        <td>${listsanpham.giaSP}</td>
        <td>${listsanpham.soLuong}</td>
        <td>${listsanpham.color}</td>
        <td>${listsanpham.danhMuc}</td>
        <td>
          <form>
            <a href="/sanpham?action=edit&index=${loop.index}" class="btn btn-warning">Edit</a>
          </form>
        </td>
        <td>
          <form>
            <a href="/sanpham?action=delete&index=${loop.index}" class="btn btn-danger">Delete</a>
          </form>
        </td>
      </tr>
    </c:forEach>
